<div class="modal fade " id="ModalSeeIIA" tabindex="-1" role="dialog" 
            ...
            <div class="tile">
              ...
              <div class="tile-body">
                <div class="table-responsive">
                  <table class="table table-hover table-bordered" id="DataTableSeeIIA" class="display" cellspacing="0" cellpadding="3" width="100%">
                    <thead>
                      <tr>
                        <th>Periodo</th>
                        <th>Ultimo pago</th>
